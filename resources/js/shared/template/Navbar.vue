                ...
                >
                    ...
                    <div class="dropdown-menu dropdown-menu-end py-0">
                        <div class="dropdown-menu-header border-bottom py-50">
                            <div
                                class="dropdown-header d-flex align-items-center py-2"
                            >
                        ...
                        >
                            <div class="row row-bordered overflow-visible g-0">
                                <div class="dropdown-shortcuts-item col">
                                    ...
                                    >
                                        <i
                                            class="ri-calendar-line ri-26px text-heading"
                                        ></i>
                                    </span>
                                    <a
                                ...
                                <div class="dropdown-shortcuts-item col">
                                    ...
                                    >
                                        <i
                                            class="ri-file-text-line ri-26px text-heading"
                                        ></i>
                                    </span>
                                    <a
                            ...
                            <div class="row row-bordered overflow-visible g-0">
                                <div class="dropdown-shortcuts-item col">
                                    ...
                                    >
                                        <i
                                            class="ri-user-line ri-26px text-heading"
                                        ></i>
                                    </span>
                                    <a
                                ...
                                <div class="dropdown-shortcuts-item col">
                                    ...
                                    >
                                        <i
                                            class="ri-computer-line ri-26px text-heading"
                                        ></i>
                                    </span>
                                    <a
                            ...
                            <div class="row row-bordered overflow-visible g-0">
                                <div class="dropdown-shortcuts-item col">
                                    ...
                                    >
                                        <i
                                            class="ri-pie-chart-2-line ri-26px text-heading"
                                        ></i>
                                    </span>
                                ...
                                <div class="dropdown-shortcuts-item col">
                                    ...
                                    >
                                        <i
                                            class="ri-settings-4-line ri-26px text-heading"
                                        ></i>
                                    </span>
                                    <a
                            ...
                            <div class="row row-bordered overflow-visible g-0">
                                <div class="dropdown-shortcuts-item col">
                                    ...
                                    >
                                        <i
                                            class="ri-question-line ri-26px text-heading"
                                        ></i>
                                    </span>
                                    <a
                                        href="pages-faq.html"
                                ...
                                <div class="dropdown-shortcuts-item col">
                                    ...
                                    >
                                        <i
                                            class="ri-tv-2-line ri-26px text-heading"
                                        ></i>
                                    </span>
                                    <a
                            ...
                            >
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <a
                                        ...
                                        ><i
                                            class="ri-mail-open-line text-heading ri-20px"
                                        ></i
                                    ></a>
                                </div>
                            </div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                            <a class="dropdown-item" href="pages-pricing.html">
                                <i
                                    class="ri-money-dollar-circle-line ri-22px me-3"
                                ></i
